...
use rendering::{CardComponent, BoardZone, EndTurnButton, DayCounter, PhaseIndicator, ResourcesDisplay};
use rendering::ui::{create_top_bar, create_hand_area, create_end_turn_button, update_day_counter, update_phase_indicator, update_resources_display};
...
fn setup(
    ...
    commands.spawn(NodeBundle {
        ...
        background_color: BackgroundColor(Color::rgb(0.08, 0.06, 0.04)),
        ..default()
    });
